package Miniature_Framework.utilities;
...
public class Utils {
	...
	public Properties init_prop()
	{
		prop = new Properties();
		try {
			FileInputStream ip = new FileInputStream(System.getProperty("user.dir") + "/src/test/java/Miniature_Framework/config.properties");
			prop.load(ip);
